  ...
  return (
    ...
    <div className="min-h-screen flex flex-col justify-center items-center">
      <div className="max-w-md w-full p-8 bg-white shadow-lg rounded-lg border border-gray-200">
        ...
        {!profileExists && (
          <p className="text-center text-gray-600 mb-6">Hey {user ? user.name : 'there'}! Your profile isn't completed. Please fill it out to get the best personalized AI suggestions.</p>
        )}

        {profileExists && (
            <p className="text-center text-gray-600 mb-6">Hey {user ? user.name : 'there'}! Your Profile is completed. You're all set to get the best personalized AI suggestions.</p>
        )}
